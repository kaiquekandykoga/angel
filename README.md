...
| [`docs/EVAL.md`](docs/EVAL.md) | `npm run eval` — scoring the review agents against a fixed dataset with deterministic checks, and sending the run to the local Langfuse `npm run eval:up` starts |
